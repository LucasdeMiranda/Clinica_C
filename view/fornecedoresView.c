    ...
    do
    {
        ...
        else
        {
            if (op == 1)
            {
                ...
                *fornecedores = cadastrarfornecedor(*fornecedores, tamfornecedor, codigoatatual, &novofornecedor);
            ...
            else if (op == 2)
            {
                ...
                if (posicao == -1)
                {
                    printf("Fornecedor não encontrado ou lista vazia.\n");
                }
                else
                {
                    printf("Digite o nome: ");
            ...
            else if (op == 3)
            {
                ...
                *fornecedores = excluirfornecedor(*fornecedores, tamfornecedor, codigo);
                ...
                {
                    printf("Fornecedor não encontrado para exclusão\n");
                }
            }
            else if (op == 4)
            {
